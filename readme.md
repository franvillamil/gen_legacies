...
- input_CIS > encuestas_CIS (merge, no se pueden poner los microdatos online)
- dataset_CIS (clean TOP, etc)
- analyses_CIS
- analyses_CIS2760
...
1. `asoc_agg`
2. `dataset_local`
3. `analyses_local` (Figure A11, Tables A8 & A9)
4. `desc_local` (Figures A9, A10)